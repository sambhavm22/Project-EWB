...
from Insurance.entity.config_entity import MODEL_FILE_NAME, TRANSFORM_OBJECT_FILE_NAME, TARGET_ENCODER_OBJECT_FILE_NAME
...
class ModelResolver:
    ...
    def __init__(self, model_registry:str = "saved_models",
        ...
        self.transformer_dir_name = target_encoder_dir_name
...
#5
    def get_latest_save_dir_path(self) -> str:
        ...
        try:
            ...
            return os.path.join(self.model_registry, f"{latest_dir_num+1}") #add 1 so that it will increase everytime new folder
